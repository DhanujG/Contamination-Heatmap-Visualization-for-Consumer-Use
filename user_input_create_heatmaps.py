...
def create_chemical_heatmaps(filename, d, chem_name, year):
    ...
    f = csv.reader(open(('/mnt/c/Users/dhanu/Documents/EcoData/output/chem_files/' + filename), 'rt'))
    vals = {}
    # Skip header line
    next(f)
    ...
    if not os.path.exists('/mnt/c/Users/dhanu/Documents/EcoData/output/maps/'+ chem_name):
      os.makedirs('/mnt/c/Users/dhanu/Documents/EcoData/output/maps/'+ chem_name)

    # Export figure to bitmap
    savefig('/mnt/c/Users/dhanu/Documents/EcoData/output/maps/'+ chem_name + '/' + chem_name + '_' + year + '_map.png')
    close()
...
def choose_chemical_heatmaps(chem_option):
    ...
    if chem_option == 'all_chemicals':
        ...
        folder = '/mnt/c/Users/dhanu/Documents/EcoData/output/chem_year_index/'
        ...
        for file in os.listdir("/mnt/c/Users/dhanu/Documents/EcoData/output/chem_files/"):
         ...
         os.chdir('/mnt/c/Users/dhanu/Documents/EcoData/output/chem_year_index/')
    ...
    #do a similar process except now when the user only selects for the single 
        ...
        filePath = ("/mnt/c/Users/dhanu/Documents/EcoData/output/chem_year_index/" + chem_option +".txt")
...
def create_chemical_index():
        ...
        filePath = ("/mnt/c/Users/dhanu/Documents/EcoData/output/")
        textfile = ("/mnt/c/Users/dhanu/Documents/EcoData/output/chem_index.txt")
        ...
        for file in os.listdir("/mnt/c/Users/dhanu/Documents/EcoData/output/chem_files/"):
                ...
                with open('/mnt/c/Users/dhanu/Documents/EcoData/output/chem_index.txt') as w:
...
if __name__ == '__main__':
    ...
    if chem_option != "all_chemicals":
        textfile = ("/mnt/c/Users/dhanu/Documents/EcoData/output/chem_year_index/" + chem_option +".txt" )
        with open('/mnt/c/Users/dhanu/Documents/EcoData/output/chem_index.txt') as w:
            if chem_option in w.read():
                ...
                print(message)
                f.close()
                print("Michigan heatmaps found in /mnt/c/Users/dhanu/Documents/EcoData/output/maps/")
            else:
